...
export default function LandingPage() {
  ...
  // ✅ Redirect immediately when connected
  useEffect(() => {
    if (isConnected) {
  ...
  return (
    <main className="bg-[url('https://ik.imagekit.io/Ochoja01/bg.png?updatedAt=1755582280091')] bg-center bg-fixed bg-cover bg-no-repeat text-white min-h-screen flex flex-col items-center pt-10">
      ...
      <div className='mt-[10%] text-center'>
        {/* Title */}
        <h1
          className={`${bebasNeue.className} text-7xl font-bold uppercase mt-6`}>
              ...
              return (
                <div
                  ...
                  <button
                    ...
                    className='px-8 py-3 text-primary-110 hover:text-white bg-white hover:bg-primary-110 rounded-full cursor-pointer hover:border-white hover:border'>
